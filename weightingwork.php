...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>VegiFresh - Weighting</title>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav">
                            ...
                            <a href="#" onclick="gotoweighting()" class="nav-item nav-link active">Weighting</a>
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex justify-content-center">
                                <button class="w-25 btn form-control border-secondary py-1 px-1 bg-white text-primary" type="button"">SET</button>
                            </div>
                        </div>
                    </div>
                </div>
