...
<html lang="en">
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h1 class="mb-3 display-3 text-primary">Here for Organic Veggies</h1>
                        <div class="position-relative mx-auto">
                            <br><button type="button" class="btn btn-primary border-2 border-secondary py-2 px-3 position-absolute rounded-pill text-white h-150" onclick="gotologin()">Get started</button><br>
                            <!-- <br><button type="button" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#confirmationModal">Get Started</button> -->
                        </div>
                    </div>
  ...
  $('#confirmAction').click(function() {
    ...
    $('#confirmationModal').modal('hide'); // Close the modal after confirmation
  });
});
              </script> -->
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                <h5>No Shipping</h5>
                                <p class="mb-0">Not even on order over $300</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                <h5>No Returns</h5>
                                <p class="mb-0">0 day money guarantee</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                    ...
                    <p>The best of the best, straight from our farmers in Nuwara Eliya.</p>
                </div>
                <div class="row g-4 justify-content-center">
